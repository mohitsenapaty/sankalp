    ...
    return (
      ...
      <DrawerLayout
        ...
        <ScrollView style={stylesAdmin.Container}>
          ...
          <TouchableOpacity onPress={this.goToHostelPage} style={stylesAdmin.ButtonContainer}>
            <Text style={stylesAdmin.ButtonText}>View/Add Hostels.</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={this.goToHousePage} style={stylesAdmin.ButtonContainer}>
            <Text style={stylesAdmin.ButtonText}>View/Add Houses.</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={this.goToGoBackPage} style={stylesAdmin.ButtonContainer}>
