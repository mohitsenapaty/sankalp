          ...
          , function(err, res)
        {
          ...
          { //console.log(res);
            ...
            for (var i = 0; i < res.rows.length; i++){
              if (!res.rows[i].exam_group_id)
                data_arr.push(res.rows[i]);
              else if (res.rows[i].exam_group_id == exam_group_id)
                data_arr.push(res.rows[i]);
            }
