...
router.post('/:pwd/:schoolName/', function(req, resp, next){
  ...
  var hostel_name = req.body.hostel_name;
  var hostel_address = req.body.hostel_address;
  ...
  if (loginType == 'Admin'){
    ...
    db_client.connect(function(err_){
      ...
      db_client.query("INSERT INTO hostel_detail(hostel_name, hostel_address) VALUES ($1,$2);"
        ,[hostel_name, hostel_address], function(err, res)
      {
        if (err){
          console.log(err); 
          resp.send(login_data);
